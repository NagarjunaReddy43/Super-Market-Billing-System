...
ResultSet Rs = null;
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       ...
       {
        String Query = "Select * from supermarketdb.sellertbl where SELNAME='"+Uid.getText()+"'and SELPASS='"+password.getText()+"'";
       try{
       ...
       {
       String Query = "Select * from supermarketdb.admintbl where Adminname='"+Uid.getText()+"'and Adminpass='"+password.getText()+"'";
       try{
        Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/supermarketdb","root","Nagarjuna4036@");
        St = Con.createStatement();
        Rs = St.executeQuery(Query);
