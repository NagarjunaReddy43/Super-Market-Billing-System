...
public class Selling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(ProdName, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 290, -1));

        jLabel5.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        jLabel5.setText("NAME");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 77, 22));
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, -1, 15));
        ...
        jPanel2.add(FilterBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 100, -1, -1));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 515, 130));
        ...
        jPanel2.add(UpdateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 630, 121, -1));
        ...
        jPanel2.add(Grdtotallbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 600, -1, 24));
        ...
        jPanel2.add(RefreshBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 100, -1, -1));
        ...
        CatCb.setBackground(new java.awt.Color(204, 204, 255));
        CatCb.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        CatCb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Beverages", "Apples", "Bananas", "vegetables" }));
        jPanel2.add(CatCb, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 100, 280, 40));

        jButton1.setBackground(new java.awt.Color(0, 0, 0));
        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Edit");
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 420, 130, 40));
        ...
        try {
            Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/supermarketdb","root","Nagarjuna4036@");
...
public void Update()
        ...
        try{
            Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/supermarketdb","root","Nagarjuna4036@");
            String Query = "Update supermarketdb.producttbl set ProdQty="+newQty+""+"where ProdId="+Prid;
 ...
 private void GetCat()
 {
   ...
   }catch(Exception e)
   {
    ...
    Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/supermarketdb","root","Nagarjuna4036@");
    St = Con.createStatement();
    Rs = St.executeQuery("Select * from supermarketdb.producttbl where ProdCat='"+CatCb.getSelectedItem().toString()+"'");
    ProductTable.setModel(DbUtils.resultSetToTableModel(Rs));
   }catch(Exception e)
   {
       e.printStackTrace();
